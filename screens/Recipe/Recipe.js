...
const Recipe = (props) => {
    return(
        <View style={styles.main}>
            ...
            <Image source={{ uri: props.navigation.getParam('recipePhoto') }} />
            </View>
            <View>
    ...
    <Text style={{...styles.heading, fontSize: 22, letterSpacing: 1, marginLeft: 8, marginBottom:20}}>Serving Size                    {props.navigation.getParam('recipeServingsize')}</Text>
                ...
                <Text style={{...styles.heading, fontSize: 25, textDecorationLine: 'underline', marginTop: 20}}> Ingredients </Text>
            </View>
            </ScrollView>
         </View>
