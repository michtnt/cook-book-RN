...
const Recipe = (props) => {
    ...
    <Text style={{...styles.heading, fontSize: 22, letterSpacing: 1, marginLeft: 8, marginBottom:20}}>Serving Size                    {props.navigation.getParam('recipeServingsize')}</Text>
                ...
                <View>
                <Text style={{...styles.heading, fontSize: 25, textDecorationLine: 'underline', marginTop: 20, marginBottom:20}}> Ingredients </Text>
                <Text style={styles.text}> {props.navigation.getParam('recipeIngredients')}</Text>
                <Text style={{...styles.heading, fontSize: 25, textDecorationLine: 'underline', marginTop: 20, marginBottom:20}}> Directions </Text>
                <Text style={styles.text}> {props.navigation.getParam('recipeDirections')}</Text>
                <Text style={{...styles.heading, fontSize: 25, textDecorationLine: 'underline', marginTop: 20, marginBottom:20}}> Notes </Text>
                <Text style={{...styles.text, marginBottom: 30}}> {props.navigation.getParam('recipeNotes')}</Text>
                <Rating 
                  imageSize={30}
                  count={5}
                  readonly
